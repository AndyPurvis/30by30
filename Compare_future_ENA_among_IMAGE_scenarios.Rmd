...
In 2050, BID has markedly higher effective natural area than CRJ in some endemic-rich regions (notably the Andean chain and East African rift system); but HPR also has higher effective natural area than CRJ in these areas. 
...
plot(subset(A_BID, y2050) - subset(A_CRJ, y2050), main = "BID - CRJ: Effective natural area in 2050")
plot(subset(A_CRJ, y2050) - subset(A_HPR, y2050), main = "CRJ - HPR: Effective natural area in 2050")
...
diff <- S_BID[,,y2050] - S_CRJ[,,y2050]
image(t(diff * (diff>0)), ylim=c(1,0), bty="n", xaxt="n", yaxt="n", main="BID has more endemics in 2050 than CRJ")
image(t(-diff * (diff < 0)), ylim=c(1,0), bty="n", xaxt="n", yaxt="n", main="CRJ has more endemics in 2050 than BID")

diff <- S_CRJ[,,y2050] - S_HPR[,,y2050]
image(t(diff * (diff>0)), ylim=c(1,0), bty="n", xaxt="n", yaxt="n", main="CRJ has more endemics in 2050 than HPR")
image(t(-diff * (diff < 0)), ylim=c(1,0), bty="n", xaxt="n", yaxt="n", main="HPR has more endemics in 2050 than CRJ")
