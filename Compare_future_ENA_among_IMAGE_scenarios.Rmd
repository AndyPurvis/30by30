...
plot(subset(A_GDN, y) - subset(A_HPR, y), main = "GDN - HPR: Effective natural area in 2050")
plot(subset(A_BID, y) - subset(A_CRJ, y), main = "BID - CRJ: Effective natural area in 2050")
plot(subset(A_CRJ, y) - subset(A_HPR, y), main = "CRJ - HPR: Effective natural area in 2050")
