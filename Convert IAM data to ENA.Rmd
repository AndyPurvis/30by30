...
The code loops through the four IAMs, processing each file within their respective folders (seven or eight per IAM). For each, it writes a new raster stack and (optionally) a pdf report. It also maps the signed difference between IAM and LUH2 for the year 2010 and plots the cell-wise correlation.
