...
nested_rsr <- exp(raster::resample(log_rsr, nested_raster))
extract(nested_rsr, cbind(0,0))
id_nested_rsr = which.max(nested_rsr)
print(xyFromCell(nested_rsr,id_nested_rsr))
rsr <- aggregate(nested_rsr, fact=44, fun=sum)
