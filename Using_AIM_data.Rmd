...
image_projections$BID <- readRDS(file.path("output/endemics","asluAIM_BID-12Feb2020_FinalMask.nc.Rds"))
image_projections$CRJ <- readRDS(file.path("output/endemics","asluAIM_CRJ-12Feb2020_FinalMask.nc.Rds"))
image_projections$GDN <- readRDS(file.path("output/endemics","asluAIM_GDN-12Feb2020_FinalMask.nc.Rds"))
image_projections$HPR <- readRDS(file.path("output/endemics","asluAIM_HPR-12Feb2020_FinalMask.nc.Rds"))
image_projections$NRS <- readRDS(file.path("output/endemics","asluAIM_NRS-12Feb2020_FinalMask.nc.Rds"))
image_projections$THC <- readRDS(file.path("output/endemics","asluAIM_THC-12Feb2020_FinalMask.nc.Rds"))
image_projections$WAC <- readRDS(file.path("output/endemics","asluAIM_WAC-12Feb2020_FinalMask.nc.Rds"))
